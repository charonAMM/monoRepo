...
let cit = await hre.ethers.getContractAt("incentiveToken/contracts/Auction.sol:Auction", c.CIT, sepSigner)
...
cit = await hre.ethers.getContractAt("incentiveToken/contracts/Auction.sol:Auction", c.CIT, sepSigner)
