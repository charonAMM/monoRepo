...
async function getProof({
  ...
  if(test){
    ...
    proof = await prove(input, `./artifacts/circuits/transaction${inputs.length}_js/transaction${inputs.length}`, `./artifacts/circuits//charon_ceremonyFINAL${inputs.length}`)
  }
